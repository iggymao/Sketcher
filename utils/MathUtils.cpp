...
static const int YZ_PLANE = 0; // for the YZ plane
static const int XZ_PLANE = 1; // for the XZ plane
static const int XY_PLANE = 2; // for the XY plane
...
inline GLfloat area_3P(glm::vec3 point_1, glm::vec3 point_2, glm::vec3 point_3)
{
	GLfloat area;
	glm::vec3 vec1, vec2;
...
inline GLfloat area_2V(glm::vec3 A_vector, glm::vec3 B_vector)
{
	GLfloat area;
...
inline int point_inside_triangle(glm::vec3 check_point, glm::vec3 point_1, glm::vec3 point_2, glm::vec3 point_3)
{
...
inline glm::vec3 ray_intersect_plane(glm::vec3 camera_loc, glm::vec3 ray, int plane)
{
